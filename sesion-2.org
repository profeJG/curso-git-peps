...
*** Entrega de la tarea
    Guarda el fichero con las capturas en formato *PDF* y nómbralo según el patrón ~APELLIDOS_NOMBRE_sesion2.pdf~. La entrega del fichero se realizará a través de la plataforma Moodle de AULES.
